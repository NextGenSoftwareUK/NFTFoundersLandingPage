...
Canonical source is `.env.example` in the OASISNFTStore repo. Reproduced here for reference:

```env
# ── OASIS Web4 API ─────────────────────────────────────────
OASIS_API_URL_LIVE=https://api.web4.oasisomniverse.one
OASIS_API_URL_TEST=https://api.test.web4.oasisomniverse.one
OASIS_AVATAR_USERNAME_LIVE=your-platform-username
OASIS_AVATAR_PASSWORD_LIVE=your-platform-password
OASIS_AVATAR_ID_LIVE=your-platform-avatar-id
OASIS_AVATAR_USERNAME_TEST=your-test-username
OASIS_AVATAR_PASSWORD_TEST=your-test-password
OASIS_AVATAR_ID_TEST=your-test-avatar-id

# ── OASIS Web6 AI API ───────────────────────────────────────
OASIS_WEB6_URL=https://api.web6.oasisomniverse.one

# ── OASIS STARNET / Web5 API ───────────────────────────────
...
# ── Email ──────────────────────────────────────────────────
RESEND_API_KEY=re_...
EMAIL_FROM=noreply@oasisnftstore.io

# ── Admin ──────────────────────────────────────────────────
ADMIN_PASSWORD=your-admin-password
SITE_URL=https://oasisnftstore.io

# ── Platform Fees ──────────────────────────────────────────
PLATFORM_FEE_PCT=2.5
PLATFORM_SOL_WALLET=your-platform-sol-wallet
PLATFORM_ETH_WALLET=0x...your-platform-eth-wallet

# ── Webhooks ───────────────────────────────────────────────
WEBHOOK_SIGNING_SECRET=your-webhook-signing-secret

# ── Custom Domains (Vercel Pro only) ───────────────────────
# Uncomment when upgrading to Vercel Pro (see Phase 11)
# VERCEL_TOKEN=your-vercel-api-token
# VERCEL_PROJECT_ID=prj_xxxxxxxxxxxxxxxxxxxx
# VERCEL_TEAM_ID=team_xxxxxxxxxxxxxxxxxxxx   ← only if project is under a team
