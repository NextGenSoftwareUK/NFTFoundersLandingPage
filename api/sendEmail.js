      ...
      body: JSON.stringify({
        ...
        html: `
          <div style="background:#01040f;color:#e0e0e0;font-family:sans-serif;padding:40px;max-width:560px;margin:0 auto;border-radius:16px;border:1px solid #00e5ff22">
            ...
            ${activationSection}
            <p style="color:#666;font-size:13px">${activationUrl ? 'Your NFT has been linked to your OASIS avatar. Complete activation to choose your new password and finish setup.' : 'Your NFT grants you Founder access to the OASIS. It should appear in your wallet shortly.'}</p>
